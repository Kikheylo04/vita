...
export type AdminPage = 'dashboard' | 'reservaciones' | 'menu' | 'testimonios' | 'eventos' | 'mensajes' | 'pedidos' | 'config' | 'cuenta' | 'sucursales' | 'inventario' | 'recetas' | 'carta' | 'clientes' | 'plan' | 'dominio' | 'finanzas' | 'planes' | 'diseno' | 'inicio' | 'cliente'
